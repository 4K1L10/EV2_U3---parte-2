...
namespace MercDevs_ej2.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Verdescripcion(int? id)
        {
            ...
            // Obtener las descripciones del servicio
            var verdescripcion = _context.Descripcionservicios
                .Where(m => m.ServicioIdServicio == id); // Asegúrate de que 'ServicioId' es el nombre correcto del campo en tu modelo
